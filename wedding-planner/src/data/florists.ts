...
export const FLORISTS: FloristItem[] = [
  { id: "f1", companyName: "Company Name", title: "Bukiet ślubny – peonie", desc: "Pastelowe peonie z delikatną zielenią.", priceFrom: 3500,
  ...
  { id: "f2", companyName: "Company Name", title: "Bukiet panny młodej – biel", desc: "Białe róże i eustoma, klasyczna elegancja.", priceFrom: 3500,
    image: "https://images.unsplash.com/photo-1519225421980-715cb0215aed?auto=format&fit=crop&q=80&w=2070" },
  { id: "f3", companyName: "Company Name", title: "Dekoracja stołu – centerpiece", desc: "Niska kompozycja na stół weselny.", priceFrom: 3500,
  ...
  { id: "f4", companyName: "Company Name", title: "Łuk ślubny – ceremonia", desc: "Zieleń i kwiaty na tle pleneru.", priceFrom: 3500,
    image: "https://images.unsplash.com/photo-1595467959554-9ffcbf37f10f?auto=format&fit=crop&q=60&w=600" },
  { id: "f5", companyName: "Company Name", title: "Butonierka pana młodego", desc: "Minimalistyczna róża z zielenią.", priceFrom: 3500,
    image: "https://images.unsplash.com/photo-1603026198288-6a94fa57e2af?auto=format&fit=crop&q=60&w=600" },
  { id: "f6", companyName: "Company Name", title: "Dekoracja alejki", desc: "Kwiaty przy krzesłach wzdłuż przejścia.", priceFrom: 3500,
